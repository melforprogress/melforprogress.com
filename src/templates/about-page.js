      ...
      <PageUnderNavbar>
        <section className="section section--gradient">
          ...
          <div className="header_para">
            <b>Melquiades Gagarin</b> is a Queens native, a community organizer, a policy advocate, a father of three, and a punk rocker running for Congress to fight for you.
          </div>
